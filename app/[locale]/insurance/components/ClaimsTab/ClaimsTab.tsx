...
import { IClaimForm, TFormStatus } from "@/types/form";
...
function ClaimsTab () {
    ...
    const statuses = {
      idle: <>
        ...
        <Button type="submit"
          ...
          {status === 'pending' ? <Spinner data-icon="inline-start"/> : <TriangleAlertIcon className='w-5 h-5'/>}
          {t('submit')}
        </Button></>,
  ...
  }, [status, claimButtonDisabled, claimForm, claimFormValid])
